...
<qgis version="3.22.11-Bia?owie?a">
  <identifier>harare_sub_sect_a_msf_2</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>harare_sub_sect_a_msf_2</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link type="Local Area Network" size="" url="file://\\GVA129857-2009\D$\ICRC GIS DATA\PolyClinics GIS MappingSecond\Harare Surbubs\zimdistricts08_Clip.shp" description="" mimeType="" name="Shapefile" format=""/>
  </links>
  <fees></fees>
