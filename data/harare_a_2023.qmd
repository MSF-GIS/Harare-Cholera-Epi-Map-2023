...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link url="file://\\GVA129857-2009\D$\ICRC GIS DATA\PolyClinics GIS MappingSecond\Harare Surbubs\zimdistricts08_Clip.shp" format="" description="" name="Shapefile" type="Local Area Network" mimeType="" size=""/>
  </links>
  <fees></fees>
